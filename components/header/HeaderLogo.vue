<template>
  <div>
    ...
    <p class="transition-all duration-300 ml-2 mt-4" :class="{'text-[0.55rem] mt-2' : isScrolled, 'text-xxs text-center mymd:text-left' : isFooter, 'text-xs' : !isFooter }">FENETRE-PORTE-VITRERIE ALU-PVC-BOIS</p>
  </div>
</template>

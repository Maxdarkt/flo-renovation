    ...
    <div class="lg:max-w-screen-lg grid grid-cols-12 xxs:gap-8 md:gap-12 justify-center items-center px-4 mt-12 mb-24 mx-auto">
      ...
      >
        <CardVertImgDesc 
          ...
          :to="item.to"
          class="w-[280px] xxs:w-[300px] sm:w-[350px] md:w-[400px]" 
        />
      </div>
    </div>
    <BannerStrongPoint />
...
import CarousselMultiplesPictures from "~/components/caroussel/CarousselMultiplesPictures.vue";
